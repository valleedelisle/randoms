...
BUILD=passed_phase2
#BUILD=Z5
HOST=dell-r740-3.gsslab.rdu2.redhat.com
HOST_USER=root
...
time infrared tripleo-undercloud --version $VERSION --build $BUILD --images-task rpm --ssl true  --tls-ca https://password.corp.redhat.com/RH-IT-Root-CA.crt
##--cdn cdn_creds.yml
